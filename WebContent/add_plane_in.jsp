...
<body>
	...
	<div class="pd-20">
		<div class="Huiform">
			<form action="AddServlet?action=addplane" onsubmit="return check()"
					...
					<tbody>
						<tr>
							...
							<td><input type="text" style="width: 300px"
								class="input-text" id="add_startcity" name="add_startcity"></td>
						</tr>
						<tr>
							<th width="100" class="text-r"><span class="c-red">*</span>
								到达城市：</th>
							<td><input type="text" style="width: 300px"
								class="input-text" id="add_lastcity" name="add_lastcity"></td>
						</tr>
						<tr>
							<th class="text-r"><span class="c-red">*</span> 所属公司：</th>
							<td><select style="width: 300px" class="select"
								id="add_company" name="add_company">
						...
						<tr>
							...
							<td><input type="text" style="width: 300px"
								class="input-text" id="add_arilineCode" name="add_arilineCode"></td>
						</tr>
						<tr>
							<th class="text-r"><span class="c-red">*</span> 起始机场：</th>
							<td><input type="text" style="width: 300px"
								class="input-text" id="add_startDrome" name="add_startDrome"></td>
						</tr>
						<tr>
							<th class="text-r"><span class="c-red">*</span> 到达机场：</th>
							<td><input type="text" style="width: 300px"
								class="input-text" id="add_arriveDrome" name="add_arriveDrome"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" style="width: 300px"
								class="input-text" id="add_mode" name="add_mode"></td>
						</tr>
						<tr>
							<th class="text-r"><span class="c-red">*</span> 经停：</th>
							<td><input type="text" style="width: 300px"
								class="input-text" id="add_stop" name="add_stop"></td>
						</tr>
						<tr>
